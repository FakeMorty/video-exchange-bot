...
from app.services import (
    ...
    rate_video, claim_daily_bonus, get_video_stats_for_user,
    count_referrals, create_payment, apply_successful_payment,
)
...
async def successful_payment(message: Message):
    ...
    try:
        ...
        logger.error(traceback.format_exc())
        await message.answer("Оплата прошла, но произошла ошибка при начислении монет. Напишите администратору.")
...
print("user_handlers.py rewritten OK")