...
# === ОФФЕРЫ / АРЕНДА ===
OFFER_DEFAULT_RENT_COST_PER_DAY = _get_float("OFFER_DEFAULT_RENT_COST_PER_DAY", 20.0)
OFFER_MIN_RENT_DAYS = _get_int("OFFER_MIN_RENT_DAYS", 1)
OFFER_MAX_RENT_DAYS = _get_int("OFFER_MAX_RENT_DAYS", 30)
# === УМНАЯ РЕКЛАМА ===
SMART_AD_MIN_INTERVAL_MINUTES = _get_int("SMART_AD_MIN_INTERVAL_MINUTES", 20)
SMART_AD_LOW_BALANCE_THRESHOLD = _get_float("SMART_AD_LOW_BALANCE_THRESHOLD", 3.0)
SMART_AD_LOW_BALANCE_HINT_INTERVAL_MINUTES = _get_int("SMART_AD_LOW_BALANCE_HINT_INTERVAL_MINUTES", 30)
SMART_AD_VIDEO_CHANCE = _get_float("SMART_AD_VIDEO_CHANCE", 0.35)
SMART_AD_FORCED_WATCH_SECONDS = _get_int("SMART_AD_FORCED_WATCH_SECONDS", 5)