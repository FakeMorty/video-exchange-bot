...
# Viewer-friendly пакеты Stars (заградительные цены ~в 15 раз дороже)
# Цены на те же пакеты монет увеличены в 5 раз относительно базового прайса.
STARTER_PACK_STARS = _get_int("STARTER_PACK_STARS", 135)
...
STARS_PACKAGES = {
    ...
    "pack_50":  {"stars": 750,  "coins": 500,  "title": "500 монет"},
    "pack_100": {"stars": 1500, "coins": 1000, "title": "1 000 монет"},
    "pack_200": {"stars": 3000, "coins": 2200, "title": "2 200 монет"},
}
