...
async def auto_broadcast_worker(bot):
    ...
    templates = [
        ...
        '🎡 <b>Следите за лотерейным барабаном!</b>\n\nНе пропустите розыгрыш Секслото в прямом эфире! Следите за выпадением шаров на колесе удачи прямо через встроенный WebApp. 🔴\n\n👉 Раздел <b>🎰 Лотерея-лото ➔ 🔴 Открыть Live</b>!',
