...
<body>
  ...
  <div id="offers-modal" class="modal">
    <div class="modal-content">
      ...
      <p style="font-size: 12px; text-align: center; color: var(--tg-theme-hint-color, #888);">Выполняйте задания партнёров и получайте монеты по условиям каждого оффера.</p>
...
async def auto_broadcast_worker(bot):
    ...
    templates = [
        '🎰 <b>Секслото — розыгрыш монет</b>\n\nНовый раунд уже открыт! Купите билет за монеты и следите за розыгрышем в прямом эфире. Размер призового фонда зависит от количества купленных билетов. 🎡\n\n👉 Зайдите в меню <b>🎰 Секслото</b>',
        ...
        '🏆 <b>Топы игроков</b>\n\nСравните результаты с другими пользователями: в разделе доступны рейтинги загрузчиков, зрителей, XP и текущего баланса. 🥇\n\n👉 Посмотрите лидеров в меню <b>🏆 Топы</b>!',
        ...
        '💳 <b>Пополнение баланса</b>\n\nНужно больше монет для промокодов или общения? Выберите пакет и оплатите его через Telegram Stars. ⚡\n\n👉 Нажмите кнопку <b>💳 Купить монеты</b>!'
    ]
