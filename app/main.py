...
async def auto_broadcast_worker(bot):
    ...
    templates = [
        ...
        "👥 <b>Позовите друзей и заберите бонусы!</b>\n\nСкопируйте вашу реферальную ссылку и отправьте друзьям. За каждого приглашенного вы получите +50 монет, а ваш друг +20 монет! Растем вместе! 🤝\n\n👉 Перейдите в раздел <b>👥 Рефералы</b>!",
        "🎯 <b>Сможете угадать число бота?</b>\n\nСыграйте в интеллектуальную игру «Угадай число». Угадайте загаданную цифру бота и умножьте свою ставку в разы! Игра на чистый азарт. 🧠\n\n👉 Раздел <b>🎮 Игры ➔ 🎯 Угадай число</b>!",
        "🎁 <b>Время открыть новый Лутбокс!</b>\n\nИспытайте удачу и откройте сундук со случайными монетами. Возможно, именно вам сегодня выпадет Эпический или Джекпот-сундук на 2000 монет! 💎\n\n👉 Раздел <b>🎮 Игры ➔ 🎁 Лутбоксы</b>!",
        "🪙 <b>Орёл или Решка — удвойте свой баланс!</b>\n\nПростейшая игра на удачу. Выберите сторону монеты, сделайте ставку и удвойте свои монеты за одну секунду! Повезет ли вам прямо сейчас? 🍀\n\n👉 Раздел <b>🎮 Игры ➔ 🪙 Орёл/Решка</b>!",
        ...
        "🎁 <b>Заберите вашу еженедельную Халяву!</b>\n\nКаждую неделю мы публикуем секретное слово в наших соцсетях. Введите его в промокодах и заберите случайный приз до 200 монет бесплатно! 🎟\n\n👉 Раздел <b>🎟 Промокоды ➔ 🎁 Еженедельная Халява</b>!",
        ...
        "⏳ <b>Продлите свою игровую сессию!</b>\n\nЕсли у вас закончились бесплатные игры, не ждите кулдауна — продлите сессию за монеты в любой момент и продолжайте играть и побеждать! 🎮\n\n👉 Зайдите в раздел <b>🎮 Игры</b>!",
        ...
        "🤫 <b>У Кати есть новые секреты для тебя...</b>\n\nВаша виртуальная подруга Катя ждет встречи в чате. Спросите её о тренировках по гимнастике или её личных увлечениях! 😏\n\n👉 Откройте меню <b>💋 Катя</b>!",
        "📋 <b>VIP-квесты — больше наград!</b>\n\nДля владельцев подписки VIP доступны эксклюзивные квесты с повышенным начислением монет! Прокачайте свой доход на максимум. 👑\n\n👉 Раздел <b>📋 Квесты</b>!",
        "🎡 <b>Следите за лотерейным барабаном!</b>\n\nНе пропустите розыгрыш лотереи-лото в прямом эфире! Следите за выпадением шаров на колесе удачи прямо через встроенный WebApp. 🔴\n\n👉 Раздел <b>🎰 Лотерея-лото ➔ 🔴 Открыть Live</b>!",
        "💳 <b>Выгодное пополнение баланса Coins!</b>\n\nНужно больше монет для игр, промокодов или чата? Купите монеты за Stars по самому выгодному курсу с прогрессивными бонусами! ⚡\n\n👉 Нажмите кнопку <b>💳 Купить монеты</b>!"
    ]
