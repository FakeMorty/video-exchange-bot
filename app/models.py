...
class User(Base):
    ...
    status: Mapped[str] = mapped_column(String(50), default="active") # "active", "banned"
...
class Video(Base):
    ...
    views: Mapped[list["VideoView"]] = relationship(back_populates="views")
    ratings: Mapped[list["VideoRating"]] = relationship(back_populates="ratings")
    comments: Mapped[list["Comment"]] = relationship(back_populates="comments")
    reactions: Mapped[list["ContentReaction"]] = relationship(back_populates="reactions")
