...
def video_rating_keyboard(video_id: int) -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(inline_keyboard=[
        stars,
        [InlineKeyboardButton(text="\u2764\ufe0f \u0420\u0435\u0430\u043a\u0446\u0438\u0438", callback_data=f"react_menu:{video_id}")],
        [InlineKeyboardButton(text="\U0001f4ac \u041a\u043e\u043c\u043c\u0435\u043d\u0442\u044b", callback_data=f"comments:{video_id}")],
        [InlineKeyboardButton(text="\u270d\ufe0f \u041d\u0430\u043f\u0438\u0441\u0430\u0442\u044c \u043a\u043e\u043c\u043c\u0435\u043d\u0442", callback_data=f"comment_add:{video_id}")],
...
def vip_buy_keyboard() -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(text="\U0001f48e \u041a\u0443\u043f\u0438\u0442\u044c VIP", callback_data="buy_vip")],
    ])


def games_menu_keyboard() -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(text="\U0001f4e6 \u041b\u0443\u0442\u0431\u043e\u043a\u0441", callback_data="game_lootbox")],
        [InlineKeyboardButton(text="\U0001f3b2 \u041a\u043e\u0441\u0442\u0438", callback_data="game_dice")],
        [InlineKeyboardButton(text="\U0001fa99 \u041c\u043e\u043d\u0435\u0442\u043a\u0430", callback_data="game_coinflip")],
        [InlineKeyboardButton(text="\U0001f522 \u0423\u0433\u0430\u0434\u0430\u0439 \u0447\u0438\u0441\u043b\u043e", callback_data="game_guess")],
    ])


def tops_menu_keyboard() -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(text="\U0001f3c6 \u0422\u043e\u043f \u0437\u0430\u0433\u0440\u0443\u0437\u0447\u0438\u043a\u043e\u0432", callback_data="top_uploaders")],
        [InlineKeyboardButton(text="\U0001f440 \u0422\u043e\u043f \u0437\u0440\u0438\u0442\u0435\u043b\u0435\u0439", callback_data="top_viewers")],
        [InlineKeyboardButton(text="\U0001f4c8 \u0422\u043e\u043f \u043f\u043e XP", callback_data="top_levels")],
        [InlineKeyboardButton(text="\U0001f4b0 \u0422\u043e\u043f \u0431\u043e\u0433\u0430\u0447\u0435\u0439", callback_data="top_richest")],
    ])
