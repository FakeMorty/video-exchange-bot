...
### 🚀 Космическая аркада
HTML5 Mini App в стиле Galaga: ставка, волны пришельцев и растущий множитель. Исходы считает сервер (crash-модель), есть дневной кап чистой прибыли, топы недели и админ-настройки.
