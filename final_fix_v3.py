...
# We use a more flexible replacement for the warning text.
# The text is: "⚠️ ВАЖНО: Если вы находитесь в группе, обязательно отвечайте (REPLY) на это сообщение числом, " "иначе бот из-за Privacy Mode его не увидит!",
...
# 2. Fix admin_select_user and introduce show_user_profile
